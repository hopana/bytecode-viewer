    ...
    public void start(int maxLineNumber, int majorVersion, int minorVersion) {
        ...
        this.printStream.print(
                "<html><head><style type='text/css'>" +
                        ...
                        "body,html{font-family:Consolas,Microsoft YaHei,Lucida Grande,Lucida Sans Unicode,Arial,sans-serif;font-size:90%}" +

                        "#demo .out{background-color:#FFFFFF}" +
                        "#demo .out .content{padding:0px;font-size:12px;font-family:Consolas,Microsoft YaHei,courier new,courier;white-space:pre;border-radius:0 0 10px 10px}" +
                        ...
                        "#javacode kbd{font-family:Consolas,Microsoft YaHei,courier new,courier}" +
