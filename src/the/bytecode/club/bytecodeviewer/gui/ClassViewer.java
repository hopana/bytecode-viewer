        ...
        try {
            ...
            for (Component c : com) {
                if (c instanceof RTextScrollPane) {
                    ...
                    if (next) {
                        for (String s : test) {
                            if (pane == 0 && !check1.isSelected() || pane == 1 && !check2.isSelected()) {
                                s = s.toLowerCase();
                        ...
                        canSearch = true;
                        for (String s : test) {
                            if (pane == 0 && !check1.isSelected() || pane == 1 && !check2.isSelected() || pane == 2 && !check3.isSelected()) {
                                s = s.toLowerCase();
                                search = search.toLowerCase();
                            }
